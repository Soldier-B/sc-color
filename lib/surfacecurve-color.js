/* ---------------------------------------------------------------------------- 
   ...
   ----------------------------------------------------------------------------
    The MIT License (MIT). Copyright (c) 2013, Benjamin Cronin
*/
(function() {
    ...
    var methods =
    {
        ...
        'luminance' : function()
        {
            // Based on http://dev.w3.org/csswg/css-color/#luminance
            // Linearizes the power scaling of the sRGB gamut
        ...
        'luminance8'     : function()   { return f2b( this.luminance() ); },
        'luminanceFast8' : function()   { return f2b( this.luminanceFast() ); },
        ...
        'contrastText' : function()
        {
            ...
            var b = .241 * c[0] * c[0] + 
                    .691 * c[1] * c[1] + 
                    .068 * c[2] * c[2];
            return (b < .51) ? color('white') : color('black');
        },
    ...
    if (typeof module !== "undefined" && module.exports ) {
        ...
        window.surfacecurve = window.surfacecurve || {};
        window.surfacecurve.color = color;
    }
    else if (typeof self != "undefined") {
        self.surfacecurve = self.surfacecurve || {}
        self.surfacecurve.color = color;
    }       
})();
